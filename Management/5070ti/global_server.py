...
SCHEDULER__ADDRESS = "http://127.0.0.1:8082" 
...
NODE_REGISTRY = {
    ...
    # cluster B
    "node_e": {"ip": "163.180.160.60", "agent_port": 8005, "prefix": "/nas2/data/dlwmznzl1/CCGRID/TrainingCode", "status": "idle", "current_job_id": None},
    "node_f": {"ip": "163.180.160.60", "agent_port": 8006, "prefix": "/nas2/data/dlwmznzl1/CCGRID/TrainingCode", "status": "idle", "current_job_id": None},
    "node_g": {"ip": "163.180.160.60", "agent_port": 8007, "prefix": "/data/breath12/CCGRID/TrainingCode", "status": "idle", "current_job_id": None},
    "node_h": {"ip": "163.180.160.60", "agent_port": 8008, "prefix": "/data/breath12/CCGRID/TrainingCode", "status": "idle", "current_job_id": None},
}
...
async def report_job_completed(report: JobCompleteReport):
    ...
    try:
        ...
        r = requests.post(fifo_url, json=payload, timeout=5)
...
def _trigger_run_on_nodes(job_id: str, nodes_with_paths: Dict[str, str], epochs: int, resume_from: Optional[str] = None):

...
def main():
    ...
    # 분산 샘플러 적용
    train_dataset = datasets.FashionMNIST(root='/local_datasets', train=True, download=True, transform=transform_train)
    test_dataset  = datasets.FashionMNIST(root='/local_datasets', train=False, download=True, transform=transform_val)
    ...
    val_loader = DataLoader(test_dataset, batch_size=32, sampler=test_sampler, num_workers=4, pin_memory=True)
